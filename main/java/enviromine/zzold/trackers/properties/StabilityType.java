...
public class StabilityType implements PropertyBase
{
	...
	public void GenDefaults()
	{
		...
		if(!file.exists())
		{
			...
			{
				EMINE.logger.log(Level.ERROR, "Failed to create file for StabilityTypes", e);
				return;
			}
		}
	...
	public void generateEmpty(Configuration config, Object obj)
	{
		...
		{
			EMINE.logger.log(Level.ERROR, "Tried to register config with non string object!", new Exception());
			return;
		}
	...
	public void customLoad()
	{
		...
		{
			EMINE.logger.log(Level.ERROR, "Failed to load stability types!", e);
			return;
		}
