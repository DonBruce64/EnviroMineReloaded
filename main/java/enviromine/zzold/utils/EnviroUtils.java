...
public class EnviroUtils
{
	...
	public static void extendPotionList()
	{
		...
		for(Field f : Potion.class.getDeclaredFields())
		{
			...
			{
				EMINE.logger.log(Level.ERROR, "Failed to extend potion list for EnviroMine!", e);
			}
		}
	}
	...
	public static StabilityType getDefaultStabilityType(Block block)
	{
		...
		if(type == null)
		{
			EMINE.logger.log(Level.ERROR, "Block " + block.getUnlocalizedName() + " has a null StabilityType. Crash imminent!");
		}
	...
	public static int compareVersions(String oldVer, String newVer)
	{
		...
		{
			EMINE.logger.log(Level.WARN, "An IndexOutOfBoundsException occured while checking version!", e);
			return -2;
		} catch(NumberFormatException e)
		{
			EMINE.logger.log(Level.WARN, "A NumberFormatException occured while checking version!\n", e);
			return -2;
		}
