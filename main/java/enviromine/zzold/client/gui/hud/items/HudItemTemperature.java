...
public class HudItemTemperature extends HudItem
{
	...
	{
		return I18n.format("options.enviromine.hud.temperature");
	}
	...
	public void render()
	{
		...
		if(UI_Settings.ShowText == true && !this.rotated)
		{
			...
			{
				Minecraft.getMinecraft().fontRendererObj.drawString(FdispHeat + "F", getTextPosX(), posY, 16777215);
			} else
			{
				Minecraft.getMinecraft().fontRendererObj.drawString(dispHeat + "C", getTextPosX(), posY, 16777215);
			}
		}
