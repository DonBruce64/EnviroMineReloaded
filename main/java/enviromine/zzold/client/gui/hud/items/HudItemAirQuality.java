...
public class HudItemAirQuality extends HudItem
{
	...
	{
		return I18n.format("options.enviromine.hud.air");
	}
	...
	public void render()
	{
		...
		if(UI_Settings.ShowText == true && !rotated)
		{
			...
			//Render Text
			//RenderAssist.drawTexturedModalRect(getTextPosX(), posY, 64, getHeight() * 4, 32, getHeight());
			Minecraft.getMinecraft().fontRendererObj.drawString(Gui_EventManager.tracker.airQuality + "%", getTextPosX(), posY, 16777215);
		}
		GL11.glPopMatrix();
	}
