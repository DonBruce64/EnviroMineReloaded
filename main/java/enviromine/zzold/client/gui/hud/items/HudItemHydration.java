...
public class HudItemHydration extends HudItem	{
	...
	public String getName() {
	 ...
	 {
		 return I18n.format("options.enviromine.hud.hydration");
	 }
	@Override
	...
	public void render() 
	{
		...
		if(UI_Settings.ShowText == true && !rotated)
		{
				...
				//Render Text
				Minecraft.getMinecraft().fontRendererObj.drawString(Gui_EventManager.tracker.hydration + "%", getTextPosX(), posY, 16777215);
		}
		GL11.glPopMatrix();
	}
