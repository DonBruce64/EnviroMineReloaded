...
public class HudItemSanity extends HudItem	{
	...
	public String getName() {
	 ...
	 {
		 return I18n.format("options.enviromine.hud.sanity");	 
	 }
	...
	public void render() 
	{
		...
		if(UI_Settings.ShowText == true  && !this.rotated)
		{
				...
				//Render Text
				//RenderAssist.drawTexturedModalRect(getTextPosX(), posY, 64, getHeight() * 4, 32, getHeight());
				Minecraft.getMinecraft().fontRendererObj.drawString(Gui_EventManager.tracker.sanity + "%", getTextPosX(), posY, 16777215);
		}
		GL11.glPopMatrix();
	}
