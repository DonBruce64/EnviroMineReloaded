...
public class TileEntityGas extends TileEntity
{
	...
	public void readFromNBT(NBTTagCompound par1NBTTagCompound)
	{
		...
		{
			EMINE.logger.log(Level.ERROR, "GasTile missing NBT 'GasArray', this should not happen!", new Exception());
			return;
		}
		...
		if(gases.size() <= 0)
		{
			EMINE.logger.log(Level.ERROR, "GasTile loaded " + savedGases.length + " gas units but no gases were actually added!", new Exception());
			return;
		}
	}
	...
	public boolean spreadGas()
	{
		...
		{
			EMINE.logger.log(Level.ERROR, "TileEntityGas has null block type!");
			return false;
		} else if(!(this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord) instanceof BlockGas))
		{
			EMINE.logger.log(Level.ERROR, "TileEntityGas has no block at position!");
			return false;
		}
