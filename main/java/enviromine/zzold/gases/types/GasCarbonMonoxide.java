...
public class GasCarbonMonoxide extends EnviroGas
{
	...
	public void applyEffects(EntityLivingBase entityLiving, int amplifier)
	{
		...
		if(entityLiving.worldObj.isRemote || entityLiving.isEntityUndead() || (entityLiving.getItemStackFromSlot(EntityEquipmentSlot.HEAD) != null && entityLiving.getItemStackFromSlot(EntityEquipmentSlot.HEAD).getItem() == ObjectHandler.gasMask))
		{
			return;
		}
